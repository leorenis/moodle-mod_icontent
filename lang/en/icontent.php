...
$string['maxquestionsperpages'] = 'Maximum number of questions per pages';
$string['maxquestionsperpageshelp'] = 'Maximum number of questions per pages';
$string['maxquestionsperpageshelp_help'] = 'Enter the maximum number of questions per page allowed. Enter only whole numbers. Importantly that 3 questions per page is optimal.';
...
$string['toevaluate'] = 'Grade';
$string['stropenanswer'] = '{$a} response awaiting evaluation.';
...
$string['coverpage_help'] = 'Enable to create a cover page.';
$string['icontent'] = 'Content';
$string['effects'] = 'Effects';
$string['nexttransitiontype'] = 'Next transition type';
$string['nexttransitiontypehelp'] = 'Next transition type';
$string['nexttransitiontypehelp_help'] = 'Enter with next transition type.';
$string['goback'] = 'Go back';
$string['advance'] = 'Advance';
$string['next'] = 'Next ';
$string['nextpage'] = 'Next page';
$string['prevtransitiontype'] = 'Previous transition type';
$string['prevtransitiontypehelp'] = 'Effect to previous page';
$string['prevtransitiontypehelp_help'] = 'Select the type of transition to the previous page.';
$string['previous'] = ' Previous';
$string['previouspage'] = 'Page previous';
$string['texttransitiontype'] = 'Text transition type';
$string['texttransitiontypehelp'] = 'Effect to text';
$string['texttransitiontypehelp_help'] = 'Select the type of transition to text.';
$string['tryagain'] = 'Try again';
$string['imagetransitiontype'] = 'Image transition type';
$string['imagetransitiontypehelp'] = 'Effect to image';
$string['imagetransitiontypehelp_help'] = 'Select the type of transition to images.';
$string['infomaxquestionperpage'] = '<strong>Note:</strong> Add up to 3 questions per page.';
...
$string['msgconfirmdeleteattempt'] = '<span class="label label-warning"> {$a->totalanswers} responses </span>found in the attempt. Are you sure you want to remove attempting this page?';
...
$string['doubtandnotes'] = 'Doubts and notes';
