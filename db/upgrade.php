...
function xmldb_icontent_upgrade($oldversion) {
    ...
    if ($oldversion < 2016091605) {

        $table = new xmldb_table('icontent_question_drafts');

        // Adding fields to table forum_discussion_subs.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('pagesquestionsid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('questionid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('cmid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('answertext', XMLDB_TYPE_TEXT, 'long', null, null, null, null);
    ...
    if ($oldversion < 2018030507) {
        ...
        upgrade_mod_savepoint(true, 2018030507, 'icontent');
