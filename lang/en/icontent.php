...
$string['answerfeedbacklabel'] = 'Selected answer feedback';
...
$string['duplicatepagesuffix'] = '{$a} (Copy)';
$string['edit'] = ' Edit ';
...
$string['outcomefeedbacklabel'] = 'Outcome feedback';
