...
$string['emptyquestionbank'] = '<strong><i class="fa fa-exclamation-triangle"></i> </strong>Bank question is empty.';
...
$string['answersevaluatedinfo'] = '<i class="fa fa-info-circle"></i> The answers that have been evaluated do not appear in this list.';
