...
/**
 * The mod_icontent note created event.
 *
...
/**
 * The mod_icontent note created event class.
 *
 * @package    mod_icontent
 * @since      Moodle 3.0
 * @copyright  2016 Leo Santos <leorenis@gmail.com>
...
class note_created extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'icontent', 'add note', 'view.php?id=' . $this->contextinstanceid . '&pageid=' .
    ...
    public static function get_name() {
        return get_string('eventnotecreated', 'mod_icontent');
    }
