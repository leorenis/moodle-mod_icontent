...
$page = $DB->get_record('icontent_pages', ['id' => $pageid], 'id, pagenum, title', MUST_EXIST);
// Check auth.
...
// Page setting.
$PAGE->set_url('/mod/icontent/deleteattempt.php', ['id' => $cm->id, 'pageid' => $pageid, 'sesskey' => sesskey()]);
// Header and strings.
...
$continue = new moodle_url('/mod/icontent/deleteattempt.php', ['id' => $cm->id, 'pageid' => $pageid, 'confirm' => 1]);
$cancel = new moodle_url('/mod/icontent/view.php', ['id' => $cm->id, 'pageid' => $pageid]);
