...
$string['norecordsfound'] = '<strong>Warning:</strong> No records found.';
...
$string['strmanualgrading'] = 'Questions that need to be evaluated manually';
...
$string['icontent:answerquestionstryagain'] = 'Permitir respostas ilimitadas às questões das páginas';