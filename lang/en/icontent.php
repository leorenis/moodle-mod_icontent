...
$string['msgconfirmtryagain'] = '<span class="label label-warning">{$a->totalanswers} responses </span>found in the attempt. Are you sure you want to remove attempting this page?';
